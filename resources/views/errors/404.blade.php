...
<div class="flex items-center justify-center min-h-[60vh]">
    <div class="text-center max-w-md w-full px-6">
        <div class="w-12 h-12 rounded-xl bg-white border border-slate-200 text-slate-500 grid place-items-center mx-auto mb-4">
            <i data-feather="search" class="w-6 h-6"></i>
        </div>
        <h1 class="text-3xl font-semibold tracking-tight text-slate-900">404</h1>
        <h2 class="text-sm font-semibold text-slate-700 mt-1">Halaman tidak ditemukan</h2>
        <p class="text-sm text-slate-500 mt-2 leading-relaxed">Halaman yang Anda cari tidak tersedia atau alamat URL salah.</p>
